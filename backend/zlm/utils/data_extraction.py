...
def read_data_from_url(url):
    try: 
        ...
        linkedin_selectors = ["#main-content > section.right-rail", ".job-alert-redirect-section", ".similar-jobs"]
        
        # TODO: Filter out selectors based on the website
...
def extract_text(pdf_path: str):
    ...
    try:
        ...
        print("Error: Could not read the PDF file. EOF marker not found.")
        return None
